...
ActiveRecord::Schema.define(version: 2023_07_01_081240) do
  ...
  create_table "counseling_posts", force: :cascade do |t|
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.integer "counseling_post_id"
    t.integer "post_comment_id"
    t.string "action", default: "", null: false
    t.boolean "checked", default: false, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["counseling_post_id"], name: "index_notifications_on_counseling_post_id"
